...
- "My Bugs" panel integration (enhanced: stats, filtering, attachment viewer)
- Leaderboard Panel integration
- Network request capture configuration
- File attachments (automatic in the widget)
- Programmatic bug reporting via the full `apiClient` surface
...
- **Network Capture**: Configurable `fetch()`/XHR capture with sensitive-header filtering
- **Error Boundaries**: Programmatic bug reporting via a valid function-component pattern
...
**Package**: `@boobalan_jkkn/bug-reporter-sdk` v1.3.2
